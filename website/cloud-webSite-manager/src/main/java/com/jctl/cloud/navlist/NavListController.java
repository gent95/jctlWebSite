package com.jctl.cloud.navlist;
...
import com.jctl.cloud.navbanner.NavBanner;
import com.jctl.cloud.navcontent.NavContent;
import com.jctl.cloud.navcontent.NavContentService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/website/navlist/navList")
public class NavListController extends BaseController {
    ...
    public String navContentList(NavList navList, Model model) {
        ...
        return "modules/website/navlist/navContentList";
    }
    /**
     * 跳转导航详情页面
     *
     * @return
     */
    @RequestMapping("navBannerForm")
    public String navBannerForm(NavBanner navBanner, Model model) {
//        model.addAttribute("navBanner", navBanner);
        return "modules/website/navlist/navBannerForm";
    }
    ...
    public List<Object> treeContData() {
        ...
        result.put("id", 0);
        result.put("name", "导航栏目管理");
        result.put("nodes", getTreeData());
    ...
    public String list(NavList navList, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "modules/website/navlist/navListList";
    }
    ...
    public String form(NavList navList, Model model) {
        ...
        return "modules/website/navlist/navListForm";
    }
