 ...
 */
package com.jctl.cloud.modules.gen.web;
...
import com.jctl.cloud.modules.gen.service.GenSchemeService;
import com.jctl.cloud.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.jctl.station.modules");
		}
