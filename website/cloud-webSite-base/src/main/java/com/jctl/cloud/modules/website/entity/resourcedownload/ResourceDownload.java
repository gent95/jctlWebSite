 ...
 */
package com.jctl.cloud.modules.website.entity.resourcedownload;
...
public class ResourceDownload extends DataEntity<ResourceDownload> {
	...
	public Long getNavListId() {
		return navListId;
	}

	public void setNavListId(Long navListId) {
