 ...
 */
package com.jctl.cloud.modules.website.web.newscontent;
...
import com.jctl.cloud.modules.website.service.newscontent.NewsContextService;
...
public class NewsContextController extends BaseController {
    ...
    public String list(NewsContext newsContext, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "modules/website/newscontent/newsContextList";
    }
    ...
    public String form(NewsContext newsContext, Model model) {
        ...
        return "modules/website/newscontent/newsContextForm";
    }
