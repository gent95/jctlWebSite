package com.jctl.cloud.utils.date;
...
//		}
        ...
        System.out.println(DateUtil.dateToStr(DateUtil.strToDate(DateUtil.dateToStrDD(DateUtil.dateGapDays(new Date(), -1))+" 18:00:00"), PNYYYYMMDDHHMMSS));
