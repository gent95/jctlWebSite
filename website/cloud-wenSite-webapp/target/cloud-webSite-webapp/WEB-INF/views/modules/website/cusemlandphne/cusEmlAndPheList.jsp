	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="cusEmlAndPhe">
			<tr>
				...
				<td>
					${cusEmlAndPhe.addUserId}
				</td>
				<td>
					<fmt:formatDate value="${cusEmlAndPhe.addTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${cusEmlAndPhe.updateUserId}
				</td>
				<td>
					<fmt:formatDate value="${cusEmlAndPhe.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<img src="${cusEmlAndPhe.picPath}" width="100px" height="50px"/>
				</td>
