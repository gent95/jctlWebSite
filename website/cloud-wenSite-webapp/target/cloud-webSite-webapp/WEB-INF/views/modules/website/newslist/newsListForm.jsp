...
<form:form id="inputForm" modelAttribute="newsList" action="${ctx}/website/newslist/newsList/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="title" htmlEscape="false" maxlength="255" class="input-xlarge "/>  <span style="color: red">*</span>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="website:newslist:newsList:edit"><input id="btnSubmit" onclick="check()" class="btn btn-primary"
                                                                          type="submit"
