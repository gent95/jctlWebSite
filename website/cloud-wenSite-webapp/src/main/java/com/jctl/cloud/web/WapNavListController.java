...
import com.jctl.cloud.navbanner.NavBannerService;
import com.jctl.cloud.navlist.NavList;
import com.jctl.cloud.navlist.NavListService;
import com.jctl.cloud.newscontent.NewsContext;
import com.jctl.cloud.newscontent.NewsContextService;
...
public class WapNavListController {
    ...
    public List<NavList> getList( HttpServletRequest request) {
        System.out.print(request.getSession().getServletContext().getAttribute("nav"));
        if(request.getSession().getServletContext().getAttribute("nav") != null){
            return ( List<NavList>)request.getSession().getServletContext().getAttribute("nav");
        }
        ...
        request.getSession().getServletContext().setAttribute("nav",result);
        return result;
    }
