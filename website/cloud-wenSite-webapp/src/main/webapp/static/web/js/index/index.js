var rootPath = "";
var imgCtx = "http://192.168.1.10:8085"
    ...
    for (var num in data) {
        ...
        for (var o in towNodes) {
            if (towNodes[o].child == null || towNodes[o].child == '') {
                _htm += "<div class='navigation-down-inner'><span><a href='" + rootPath + towNodes[o].url + "?navId=" + towNodes[o].id + "'> <p><img class='imgPath' src='" + imgCtx + towNodes[o].picPath + "' onmouseover='overShow(this)' onmouseout='outClose(this)'></p><p>" + towNodes[o].name + "</p> <div style='border-bottom:3px solid #f18a22; width: 26px; margin: 0 auto; margin-bottom: 15px; margin-top: 10px'></div> <p class='alias'>" + towNodes[o].alias + "</p></a> </span>";
                _htm += "<input type='hidden' class='picPath' value='" + imgCtx + towNodes[o].picPath + "'/><input type='hidden' class='picImg' value='" + imgCtx + towNodes[o].picImg + "'/>"
                _htm += " </div>"
            } else {
...
function initFristNav(nodes) {
    var _htm = " <div style='margin-right: 80px; float:left;text-align: center; margin-top: 15px;'><a href='" + "/" + "'> <img src='" + rootPath + "/static/frontImg/homepage/logo.png'/></a></div>";
